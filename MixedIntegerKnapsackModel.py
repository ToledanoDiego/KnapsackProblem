"""A Pyomo representation of the Mixed Integer Knapsack Problem.

Run the Integer Knapsack Problem with instances found in Instances/
and write results into MixedIntegerKnapsackSolution.txt.

  Typical usage example:

  python3 MixedIntegerKnapsackModel.py
"""
...
for filename in os.listdir('Instances'):
    ...
    f = open("MixedIntegerKnapsackSolutions.txt", "a")
