"""A Pyomo representation of the Integer Knapsack Problem.

Run the Integer Knapsack Problem with instances found in Instances/
and write results into IntegerKnapsackSolution.txt.

  Typical usage example:

  python3 IntegerKnapsackModel.py
"""
...
for filename in os.listdir('Instances'):
    ...
    f = open("IntegerKnapsackSolutions.txt", "a")
