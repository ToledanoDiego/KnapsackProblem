"""A Pyomo representation of the Robust Mixed Integer Knapsack Problem.

Run the Integer Knapsack Problem with instances found in Instances/
and write results into RobustMixedIntegerKnapsackSolution.txt.

  Typical usage example:

  python3 RobustMixedIntegerKnapsackModel.py
"""
...
for filename in os.listdir('Instances'):
    ...
    f = open("RobustMixedIntegerKnapsackSolutions.txt", "a")
